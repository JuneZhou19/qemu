...
inline static void fbe_queue_init(fbe_queue_head_t * head)
{
	head->next = head;
	head->prev = head;
}

inline static void fbe_queue_element_init(fbe_queue_element_t * queue_element)
{
	queue_element->next = queue_element;
	queue_element->prev = queue_element;
}

inline static fbe_bool_t fbe_queue_is_element_on_queue(fbe_queue_element_t * queue_element)
{
	return (queue_element->next != queue_element);
}

inline static void fbe_queue_destroy(fbe_queue_head_t * head)
{
	FBE_UNREFERENCED_PARAMETER(head);
}


inline static void fbe_queue_push(fbe_queue_head_t * head, fbe_queue_element_t * element)
{
...
inline static void fbe_queue_push_front(fbe_queue_head_t * head, fbe_queue_element_t * element)
{
...
inline static fbe_queue_element_t * fbe_queue_pop(fbe_queue_head_t * head)
{
	fbe_queue_element_t * first = (fbe_queue_element_t *)head->next;
	if(first == head){
		return NULL;
...
inline static fbe_bool_t fbe_queue_is_empty(fbe_queue_head_t * head)
{
	return (head->next == head);
}

inline static fbe_queue_element_t * fbe_queue_front(fbe_queue_head_t * head)
{
...
inline static void fbe_queue_remove(fbe_queue_element_t * element)
{
...
inline static fbe_queue_element_t * fbe_queue_next(fbe_queue_head_t * head, fbe_queue_element_t * element)
{
	if(fbe_queue_is_empty(head)){
		return NULL;
	}
...
/* return next element or NULL for error */
inline static fbe_queue_element_t * fbe_queue_prev(fbe_queue_head_t * head, fbe_queue_element_t * element)
{
	if(fbe_queue_is_empty(head)){
		return NULL;
	}
...
inline static void fbe_queue_insert(fbe_queue_element_t* element, fbe_queue_element_t* next_element)
{
...
inline static fbe_u32_t fbe_queue_length(fbe_queue_head_t * head)
{
	fbe_u32_t length = 0;
...
inline static void fbe_queue_merge(fbe_queue_head_t * target_head, fbe_queue_head_t * head)
{
