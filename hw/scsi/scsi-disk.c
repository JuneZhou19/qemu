...
static int scsi_disk_emulate_eses_receive_diag(SCSIRequest *req, uint8_t *outbuf, const struct SCSISense **sense_code)
{
    return 0;
}

static int scsi_disk_emulate_eses(SCSIRequest *req, uint8_t *outbuf, const struct SCSISense **sense_code)
{
    int buflen = 0;
...
static int32_t scsi_disk_emulate_command(SCSIRequest *req, uint8_t *buf)
{
    ...
    uint8_t *outbuf;
    int buflen;
    const struct SCSISense *outSense = NULL;
